Talent And Gyan - Final Navigation Fix

admin.html = Admin Panel
index.html = Student Site

Fixes in this version:
- Admin Test folders are compact and collapsible.
- Tests inside each folder open directly with View/Edit/Questions/Show-Hide/Delete controls.
- Student Mock Test opening uses a single reliable full-screen flow.
